...
function displayComputerChoice() {
  // Add 'selected' styling to one selected
...
function updateScore(playerChoice) {
  ...
  if (playerChoice === computerChoice) {
    ...
    let defeatsBot = (choice.defeats.indexOf(computerChoice) >= 0) ? true : false;
    if (defeatsBot) {
      startConfetti(2000);
      playerScoreNumber++;
...
// Start over when reset icon is clicked
function startOver() {
  resetSelected();
  playerScoreNumber = 0;
